...
setup(
    ...
    ext_modules = [
                    ...
                    Extension('pyx_utils', sources=['pyx_utils.pyx', 'src/lib/utils.cpp', 'src/lib/graph.cpp', 'src/lib/disjoint_set.cpp'], language='c++',extra_compile_args=['-std=c++11']),
                    ...
                    Extension('FINDER_API', sources = ['FINDER_API.pyx'])
                   ])