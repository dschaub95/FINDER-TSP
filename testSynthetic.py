...
#     data_test_name = ['30-50', '50-100', '100-200', '200-300', '300-400', '400-500']
    ...
    model_file = './FINDER_TSP/models/nrange_30_50_iter_93300.ckpt'
    
    file_path = '../results/FINDER_TSP/synthetic'
#     if not os.path.exists(file_path):
    if not os.path.exists('../results/FINDER_TSP'):
        os.mkdir('../results/FINDER_TSP')
    if not os.path.exists('../results/FINDER_TSP/synthetic'):
        os.mkdir('../results/FINDER_TSP/synthetic')
